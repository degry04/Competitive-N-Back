      ...
      <section className="history-panel standalone-panel">
        ...
        <GuideBlock
          ...
          items={[
            ...
            "В режиме «Последние 5» нужно нажать, если клетка уже встречалась среди последних 5 стимулов.",
        ...
        <GuideBlock
          ...
          title="Действуй / не действуй"
          items={[
            "Нажимайте только на стимулы «Действуй».",
            "Стимул «Не действуй» нужно игнорировать: лишний клик считается ложным нажатием.",
            "Пропуск стимула «Действуй» тоже штрафуется."
          ]}
        />
